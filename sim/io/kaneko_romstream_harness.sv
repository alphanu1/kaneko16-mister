...
module kaneko_romstream_harness #(
  parameter int unsigned COL_BITS = 10,   // 64 MB, matching the module in use
  ...
  localparam int unsigned NP = 11;  // must match KanekoCALC3.sv NPORTS
