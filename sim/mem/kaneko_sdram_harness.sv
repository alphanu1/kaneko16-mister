...
module kaneko_sdram_harness #(
  ...
  input  logic        p0_req, p1_req, p2_req, p3_req, p4_req, p5_req,
  input  logic        p0_we,
  input  logic [COL_BITS+15:1] p0_addr, p1_addr, p2_addr, p3_addr, p4_addr,
                               p5_addr,
  input  logic [15:0] p0_din,
  input  logic [1:0]  p0_be,
  output logic [63:0] p0_dout, p1_dout, p2_dout, p3_dout, p4_dout, p5_dout,
  output logic        p0_ack, p1_ack, p2_ack, p3_ack, p4_ack, p5_ack,
  ...
  localparam int unsigned NP    = 6;   // matches Kaneko16.sv NPORTS
  ...
  assign p_req  = {p5_req, p4_req, p3_req, p2_req, p1_req, p0_req};
  assign p_we   = {4'b0000, p0_we};
  assign p_addr = {p5_addr, p4_addr, p3_addr, p2_addr, p1_addr, p0_addr};
  assign p_din  = {64'd0, p0_din};
  assign p_be   = {8'd0, p0_be};

  assign {p5_ack, p4_ack, p3_ack, p2_ack, p1_ack, p0_ack} = p_ack;
