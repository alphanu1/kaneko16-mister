...
module kaneko_sdram_x2_harness #(
    ...
    input  logic [COL_BITS+15:1] a0, a1, a2, a3, a4, a5, a6,
    output logic [NP-1:0] p_ack,
    output logic [63:0] d0, d1, d2, d3, d4, d5, d6,
    ...
    kaneko_sdram_x2 #(.NP(NP), .AW(AW)) u_x2 (
        .clk_fast(clk),
        .s_req(p_req), .s_addr({a6, a5, a4, a3, a2, a1, a0}),
        .s_ack(p_ack), .s_dout({d6, d5, d4, d3, d2, d1, d0}),
